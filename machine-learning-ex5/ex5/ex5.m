...
%% =========== Part 9: testing for Selecting Lambda =============
%  You will now implement testCurve to test various values of 
%  lambda on a test set. You will then use this to select the
%  "best" lambda value.
%
